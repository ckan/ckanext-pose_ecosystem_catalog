...
setup(
    ...
    entry_points='''
        ...
        pose_custom_extension=ckanext.pose_theme.pose_custom_extension.plugin:PoseExtensionPlugin
        pose_custom_site=ckanext.pose_theme.pose_custom_site.plugin:PoseSitePlugin
